...
class JobTest extends PHPUnit_Framework_TestCase {
	...
	public function testCreateValidJobs() {
		...
		$time=20;
		$day = "Monday";
		$position = "PositionTUTORIAL";
		$salary = 80.30;
		$requirements = "None";
		$course = new Course("MATH 363", 3700, 50, 80,0);
		...
		$this->assertEquals($time, $this->am->getJob_index(0)->getHours());
		...
		$course = new Course("COMP 551", 2700, 50, 45,10);
		...
		$this->assertEquals($time, $this->am->getJob_index(1)->getHours());
