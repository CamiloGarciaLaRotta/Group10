...
\begin{itemize}
    \item April 3 - Present Project
    \item April 7 - Submission of slides for Deliverable 5.
    \item April 8 - Hire functionality for Desktop implemented.
    \item April 9 - Final testing of source code complete for all platforms.
    \item April 10 - Final Report for project due.
    \item April 11 - Release Day (Final source code due.
\end{itemize}
...
%% TEMPLATE
%%% JUST COPY PASTE THIS EVERY WEEK
