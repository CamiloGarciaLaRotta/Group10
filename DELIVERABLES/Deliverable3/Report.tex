...
the actor that would use those functionalities. Section \textbf{5.1} shows system tests associated
with the functionalities that only an Administrator would be responsible for. Then, section 
\textbf{5.2} shows system tests associated with the Instructor's actions. Finally, section
\textbf{5.3} shows system tests associated with the Student's actions. This categorization made it
...
section \textbf{5} verify the proper functioning of the input parsing from the Views, and the output
...
The goal of the System Test Plan described in sectio \textbf{5} is to achieve approximately 100\%
